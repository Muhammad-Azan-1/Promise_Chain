...
//First see the Call Back Hell Code
...
function getDatas(DataId:number):any{
...
console.log("Fetching data1....")
 getDatas(1).then(()=>{                      //. After 3 seocnds the promise is resolved and return to the caller of function getDatas(1) so as are promise is reolved .then() method will executed.
...
getDatas(1).then(()=>{
    ...
    return getDatas(2)          // After 3 seconds Promise is resolved and return to the caller of function getDatas(2)  now as we  return getDatas(2) to
                                 // .then() method then .then() method see that return getDatas(2) have a resolved promise so our .then() method will be executed         
}).then(()=>{                       
